...
if(isset($_SESSION["table_connection_error"])) {
    $table_connection_error = $_SESSION["table_connection_error"];
}
                ...
                <div class="main-container__login-container">
                    <div class="login-form-container">
                        <form name="login" class="login-form" method="post" action="check-user.php">
                            <div class="invalid-info" style="visibility:<?php if($user_no_match===1 || $table_empty_error===1 || $table_connection_error === 1){echo 'visible';}else{echo 'hidden';} ?>;">
                                <h4>
